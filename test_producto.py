...
from productoServices import ProductoServices
...
class TestProducto(unittest.TestCase):
    ...
    def test_add_producto(self, descripcion, precio, tipo):
        ...
        productoKey = ProductoServices().add_producto(producto)
    ...
    def test_insertion_sort_precio(self, tipo_orden, list_ordenada):
        lista_ordenada = ProductoServices().\
    ...
    #    ProductoServices().delete_producto(0)
    ...
    def test_delete_producto_value_error(self, descripcion, precio, tipo):
        ...
        with self.assertRaises(ValueError):
            ProductoServices().delete_producto(long_list+1)
